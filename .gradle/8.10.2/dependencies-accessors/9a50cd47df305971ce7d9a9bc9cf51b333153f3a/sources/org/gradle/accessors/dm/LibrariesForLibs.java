...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class ComposeLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>liveDataCompose</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getLivedata() {
            return create("compose.livedata");
        }
    ...
    public static class DaggerLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>core</b> with <b>com.google.dagger:dagger</b> coordinates and
         * with version reference <b>dagger</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getCore() {
            return create("dagger.core");
        }
    ...
    public static class OkhttpLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>loginterceptor</b> with <b>com.squareup.okhttp3:logging-interceptor</b> coordinates and
         * with version reference <b>okhttp</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getLoginterceptor() {
            return create("okhttp.loginterceptor");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>liveDataCompose</b> with value <b>1.7.8</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getLiveDataCompose() { return getVersion("liveDataCompose"); }
    ...
    public static class KspVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>ksp.version</b> with value <b>2.1.20-1.0.32</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
